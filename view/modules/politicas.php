<div class="container" id="politicas">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <p class="titulo-section">POLÍTICAS DE PREVENCIÓN</p>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 show">
            <div class="card" id="cont-col1" hidden>
                <p class="text-center">
                    OPCION 1
            ...
            <div class="card" id="cont-col2" hidden>
                <p class="text-center">
                    OPCION 2
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                    squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
            ...
            <div class="card" id="cont-col3" hidden>
                <p class="text-center">
                    OPCION 3
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                    squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
            ...
            <div class="card" id="cont-col4" hidden>
                <p class="text-center">
                    OPCION 4
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                    squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
